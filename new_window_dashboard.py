...
def add_product():
    ...
    back_button = tk.Button(button_frame, text="  Back  ", command=lambda: add_window.destroy())
    ...
    close_button = tk.Button(button_frame, text=" Close ", command=add_window.destroy)
...
def edit_product():
    ...
    back_button = tk.Button(button_frame, text="  Back  ", command=lambda: edit_window.destroy())
    back_button.pack(side="bottom", pady=2)
    ...
    close_button = tk.Button(button_frame, text=" Close ", command=edit_window.destroy)
    close_button.pack(side="right", pady=2)
